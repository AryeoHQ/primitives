...
class IntervalTest extends TestCase
{
    ...
    public function test_interval_can_be_converted_to_text(): void
    {
    ...
    public function test_interval_can_be_converted_to_text_with_custom_delimeter(): void
    {
        $interval = Interval::make(10, 20);
        $this->assertInstanceOf(Text::class, $interval->toText('||'));
        $this->assertEquals('10||20', $interval->toText('||')->value);
    ...
    public function test_interval_can_be_casted(): void
    {
